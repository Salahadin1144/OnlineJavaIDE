...
public class Javac {
    ...
    public static int COMPILATION_RESULT = 0;
    ...
    public static List<ClassInfo> compile(List<String> srcCodes) throws IOException {
        ...
        File rootDir = new File("/Users/saladin/output"); //getTmpDir(); // something like "/tmp/kilim$2348983948"
        ...
        OutputStream os = new FileOutputStream("/Users/saladin/output/file.txt");

        JavaCompiler compiler = ToolProvider.getSystemJavaCompiler();
        COMPILATION_RESULT = compiler.run(null, os, null, args);
        if(COMPILATION_RESULT == 0 ){
            compiler.run(null, os, null, null);
        }
